...
func TestAccDataSourceSdwanTopologyCustomControlProfileParcel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_topology_custom_control_feature.test", "target_level", "SITE"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_topology_custom_control_feature.test", "sequences.0.id", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_topology_custom_control_feature.test", "sequences.0.name", "Backup_TLOC"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_topology_custom_control_feature.test", "sequences.0.actions.0.set.0.preference", "5000"))
	checks = append(checks, resource.TestCheckResourceAttr("data.sdwan_topology_custom_control_feature.test", "sequences.0.actions.0.set.0.tloc_action", "backup"))
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { testAccPreCheck(t) },
		ProtoV6ProviderFactories: testAccProtoV6ProviderFactories,
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceSdwanTopologyCustomControlProfileParcelConfig(),
				Check:  resource.ComposeTestCheckFunc(checks...),
			},
			{
				Config: testAccDataSourceSdwanTopologyCustomControlProfileParcelByNameConfig(),
