...
func (d *NetworkHierarchyNodeDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the Network Hierarchy Node .",
		...
		Attributes: map[string]schema.Attribute{
			...
			"name": schema.StringAttribute{
				MarkdownDescription: "The name of the node (a grouping/folder under the hierarchy)",
				Computed:            true,
			},
