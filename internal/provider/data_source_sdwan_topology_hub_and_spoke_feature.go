...
var (
	...
	_ datasource.DataSourceWithConfigValidators = &TopologyHubAndSpokeProfileParcelDataSource{}
)
...
func (d *TopologyHubAndSpokeProfileParcelDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
