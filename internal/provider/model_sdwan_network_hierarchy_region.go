...
type NetworkHierarchyRegion struct {
...
func (data NetworkHierarchyRegion) getPath() string {
...
func (data NetworkHierarchyRegion) toBody(ctx context.Context) string {
	body := ""
	if !data.Name.IsNull() {
...
func (data *NetworkHierarchyRegion) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *NetworkHierarchyRegion) hasChanges(ctx context.Context, state *NetworkHierarchyRegion) bool {
	hasChanges := false
...
func (data *NetworkHierarchyRegion) processImport(ctx context.Context) {
}
