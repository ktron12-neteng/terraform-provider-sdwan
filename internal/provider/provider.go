...
func (p *SdwanProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewApplicationPriorityPolicySettingsProfileParcelResource,
		...
		NewEmbeddedSecurityProfileParcelResource,
		NewEmbeddedSecurityNGFWProfileParcelResource,
		NewNetworkHierarchyCflowdProfileParcelResource,
		NewNetworkHierarchySecurityLoggingProfileParcelResource,
		...
		NewPolicyObjectSecurityProtocolListProfileParcelResource,
		...
		NewSystemCACertificateProfileParcelResource,
		...
		NewNetworkHierarchyRegionResource,
		NewNetworkHierarchySiteResource,
...
func (p *SdwanProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewApplicationPriorityPolicySettingsProfileParcelDataSource,
		...
		NewEmbeddedSecurityProfileParcelDataSource,
		NewEmbeddedSecurityNGFWProfileParcelDataSource,
		NewNetworkHierarchyCflowdProfileParcelDataSource,
		NewNetworkHierarchySecurityLoggingProfileParcelDataSource,
		...
		NewPolicyObjectSecurityProtocolListProfileParcelDataSource,
		...
		NewPolicyObjectUnifiedAdvancedInspectionProfileProfileParcelDataSource,
		NewPolicyObjectUnifiedAdvancedMalwareProtectionProfileParcelDataSource,
		NewPolicyObjectUnifiedIntrusionPreventionProfileParcelDataSource,
		NewPolicyObjectUnifiedTLSSSLDecryptionProfileParcelDataSource,
		...
		NewSystemCACertificateProfileParcelDataSource,
		...
		NewNetworkHierarchyDataSource,
		NewNetworkHierarchyNodeDataSource,
		NewNetworkHierarchyRegionDataSource,
		NewNetworkHierarchySiteDataSource,
